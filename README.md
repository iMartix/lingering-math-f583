...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-math-f583
```

A live public deployment of this template is available at [https://lingering-math-f583.templates.workers.dev](https://lingering-math-f583.templates.workers.dev)
